...
class ChatTests(ChannelsLiveServerTestCase):
    ...
    # https://stackoverflow.com/questions/10586787/when-should-i-use-classmethod-and-when-def-methodself
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def testChatMessageSeenByEveryoneInSameRoom(self):
        try:
    ...
    def testChatMessageNotSeenByAnyoneInDiffRoom(self):
        try:
            self._enter_chat_room("room_1")
